...
const Filter = ({ filters, onFilterChanged }) => {
  ...
  const getChoicesForWeapons = () => {
    ...
    Object.keys(WeaponsByCategories).map((category) => {
      res.push({
        key: `C${category}`,
        text: t(WeaponCategories[category]),
        value: `C${category}`,
      });
      WeaponsByCategories[category].map((weapon) => {
        res.push({
          key: `W${weapon}`,
          text: t(Weapons[weapon]),
          value: `W${weapon}`,
          icon: "caret right",
        });
        return null;
    ...
    res.push({
      key: "other",
      text: t("csgo.types.other"),
      value: "-",
      disabled: true,
    });
    res.push({
      key: "Tagents",
      text: t("csgo.types.agents"),
      value: "Tagents",
      icon: "caret right",
    });
    res.push({
      key: "Tmusic_kits",
      text: t("csgo.types.music_kits"),
      value: "Tmusic_kits",
      icon: "caret right",
    });
    res.push({
      key: "Tgraffitis",
      text: t("csgo.types.graffitis"),
      value: "Tgraffitis",
      icon: "caret right",
    });
    res.push({
      key: "Tstickers",
      text: t("csgo.types.stickers"),
      value: "Tstickers",
      icon: "caret right",
    });
    res.push({
      key: "Tpins",
      text: t("csgo.types.pins"),
      value: "Tpins",
      icon: "caret right",
    });
    res.push({
      key: "Tpatches",
      text: t("csgo.types.patches"),
      value: "Tpatches",
      icon: "caret right",
    });
    return res;
    ...
    <Form>
      <Form.Group>
        ...
        <Form.Field
          ...
          value={quality || "all"}
          onChange={(e, { value }) =>
            onFilterChanged({ quality: value !== "all" ? value : null })
          }
        />
        <Form.Field
          control={Select}
          ...
          value={rarity || "all"}
          onChange={(e, { value }) =>
            onFilterChanged({ rarity: value !== "all" ? value : null })
          }
        />
        <Form.Field
          control={Select}
          ...
          options={[
            ...
            {
              key: "statTrak",
              text: t("csgo.filters.stat_trak"),
              value: "statTrak",
            },
            {
              key: "souvenir",
              text: t("csgo.filters.souvenir"),
              value: "souvenir",
            },
          ...
          onChange={(e, { value }) =>
            onFilterChanged({
              statTrak:
                value === "statTrak"
                  ? true
                  : value === "none" || value === "souvenir"
                  ? false
                  : null,
              souvenir:
                value === "souvenir"
                  ? true
                  : value === "none" || value === "statTrak"
                  ? false
                  : null,
            })
          }
