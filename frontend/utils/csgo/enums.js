...
const WeaponsByCategories = Object.freeze({
  ...
  heavy: ["sawed_off", "mag_7", "nova", "xm1014", "m249", "negev"],
  smgs: ["mac_10", "mp9", "pp_bizon", "mp7", "mp5_sd", "ump_45", "p90"],
  rifles: [
    "galil_ar",
    "famas",
    "ak_47",
...
export { Qualities, Rarities, WeaponCategories, Weapons, WeaponsByCategories };
